...
### Question 2: How many taxa, samples, and sample vairables are there in asgmt_physeq? (1 point)
...
### Question 4: Generate a bar plot for sample vs abudance and facet it for the catagories in SampleOrigin (1 point)
...
#### To explore the options available for hclust

run the command '?h
clust' to see the options available under method

# For question 7 to 12, use dataset 'asgmt_physeq'. 

### Question 7: Generate a Hierarchical clustering plot using the distacne "ward.D2". (2 points)
